...
def cal_pnl(temp_df: pd.DataFrame, resolution: str) -> pd.DataFrame:
    ...
    # temp_df.to_csv("temp_df_before.csv")
    # temp_df = temp_df.loc[365 if resolution == '24h' else 365*24:]
    # temp_df.to_csv("temp_df_after.csv")
...
def backtesting(
    ...
    try:
        ...
        # df.iloc[0 : (365*24) if resolution == '1h' else 365, df.columns.get_loc("bnh_pnl")] = 0
