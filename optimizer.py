    ...
    def _model_window(self, model: str) -> Tuple[np.ndarray, np.ndarray]:
        ...
        model_params = {
            "bband": {
                ...
                "1h": ((5,10000, 400), (0, 2.25, 0.1)),
                "10m": ((20, 300, 10), (0, 2.25, 0.25)),
            },
            "log_bband": {
                "24h": ((5, 375, 10), (0, 2.6, 0.1)),
                "1h": ((5, 10000, 300), (0, 2.25, 0.1)),
                "10m": ((20, 300, 10), (0, 2.25, 0.25)),
            },
            "robust": {
                "24h": ((5, 375, 10), (0, 2.6, 0.1)),
            ...
            "ma_diff": {
                ...
                "1h": ((5, 10000, 300), (0, 0.1, 0.01)),
                "10m": ((300, 12000, 300), (0, 0.1, 0.01)),
            },
            "roc": {
                "24h": ((5, 375, 10), (0, 0.21, 0.01)),
                "1h": ((5, 10000, 300), (0, 0.1, 0.005)),
                "10m": ((1, 14, 1), (0, 0.01, 0.001)),
            },
            "rsi": {
                "24h": ((5, 375, 10), (0, 102.5, 2.5)),
                "1h": ((5, 10000, 300), (0, 102.5, 2.5)),
                "10m": ((0, 20, 1), (0, 30, 1)),
            },
            "percentile": {
                "24h": ((5, 375, 10), (0, 0.525, 0.025)),
                "1h": ((5, 10000, 300), (0.03, 0.5, 0.03)),
                "10m": ((0, 20, 1), (0, 0.30, 0.02)),
            },
            "tanh": {
                "24h": ((5, 375, 10), (0, 0.525, 0.025)),
                "1h": ((5, 10000, 300), (0, 0.55, 0.03)),
                "10m": ((0, 20, 1), (0, 0.30, 0.02)),
            },
            "min_max": {
                "24h": ((5, 375, 10), (0.00, 0.125, 0.025)),
                "1h": ((5, 3000, 300), (0, 0.5, 0.03)),
                "10m": ((10, 110, 10), (0.05, 0.125, 0.05)),
            },
            "raw": {
                "24h": ((5, 375, 10), (0.00, 0.525, 0.025)),
                "1h": ((5, 10000, 300), (0.05, 0.5, 0.05)),
